...
void arrange_ship(bool sea_battle[][10])
{
	...
	for (int i = 4; i > 0; i--)
	{
		std::cout << "You can stay [I]" << i << " ships\nCoordinate: ";
	...
	for (int i = 3; i > 0; i--)
	{
		std::cout << "You can stay [I][I]" << i << " ships\nCoordinate: ";
	...
	for (int i = 2; i > 0; i--)
	{
		std::cout << "You can stay [I][I][I]" << i << " ships\nCoordinate: ";
		for (int i = 0; i < 4;i++)std::cin >> coordinata[i];
		// 9 9 9 7
		place = (coordinata[0] == coordinata[2]) || (coordinata[1] == coordinata[3]);
		...
		if (place && distance && !(sea_battle[coordinata[0]][coordinata[1]])
			&& !(sea_battle[coordinata[2]][coordinata[3]])
			&& !(sea_battle[std::abs(coordinata[0] - coordinata[2]) / 2][std::abs(coordinata[1] - coordinata[3]) / 2]))
		{
			sea_battle[coordinata[0]][coordinata[1]] = true;
			sea_battle[coordinata[2]][coordinata[3]] = true;
			int temp;
			...
			{
				temp = (coordinata[0] > coordinata[2] ? coordinata[0] : coordinata[2]);
	...
	for (int i = 1; i > 0; i--)
	{
		std::cout << "You can stay [I][I][I][I]" << i << " ships\nCoordinate: ";
		for (int i = 0; i < 4;i++)std::cin >> coordinata[i];
		// 9 9 9 7
		place = (coordinata[0] == coordinata[2]) || (coordinata[1] == coordinata[3]);
